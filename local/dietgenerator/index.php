...
if ($form->is_cancelled()) {
    ...
    $prompt = "Kullanıcının yaşı: {$data->age}, cinsiyeti: {$data->gender}, boyu: {$data->height} cm, kilosu: {$data->weight} kg. Bu bilgilere sahip bir bireyin günlük makro ihtiyacına göre 7 günlük detaylı bir diyet listesi hazırla. Absürt besinlerden oluşan bir plan olmasın. Türkiye'de yaşayan orta gelirli bir insanın uygulayabileceği düzeyde bir plan oluştur. Her gün için sabah kahvaltısı, öğle ve akşam yemeği olacak şekilde belirt. Her besinin gramajını veya adetini belirt. Belirtilen formatın dışına çıkma! Format:\n\nGün 1:\nSabah: ...\nÖğle: ...\nAkşam: ...\n\nGün 2:\n... (böyle devam et)";
